...
"""autogenerated by genpy from pt_actions/NavigateActionResult.msg. Do not edit."""
import sys
...
class NavigateActionResult(genpy.Message):
  _md5sum = "06ec270dbf484ea7a5036f076cd59e1c"
  _type = "pt_actions/NavigateActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','pt_actions/NavigateResult']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_3d().pack(_x.result.end_lat, _x.result.end_lon, _x.result.end_distance))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.end_lat, _x.result.end_lon, _x.result.end_distance,) = _get_struct_3d().unpack(str[start:end])
      return self
