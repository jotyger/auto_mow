...
"""autogenerated by genpy from pt_actions/NavigateActionFeedback.msg. Do not edit."""
import sys
...
class NavigateActionFeedback(genpy.Message):
  _md5sum = "14e8395883fff1dae05aae1a195f620b"
  _type = "pt_actions/NavigateActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','pt_actions/NavigateFeedback']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_3d2B().pack(_x.feedback.latitude, _x.feedback.longitude, _x.feedback.distanceTravelled, _x.feedback.curPoint, _x.feedback.status))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.feedback.latitude, _x.feedback.longitude, _x.feedback.distanceTravelled, _x.feedback.curPoint, _x.feedback.status,) = _get_struct_3d2B().unpack(str[start:end])
      return self
