...
if("TRUE" STREQUAL "TRUE")
  set(differential_drive_SOURCE_PREFIX /home/ubuntu/diff/src/differential-drive)
  set(differential_drive_DEVEL_PREFIX /home/ubuntu/diff/devel)
  ...
  set(differential_drive_INSTALL_PREFIX /home/ubuntu/diff/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'differential_drive' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/diff/src/differential-drive/${idir}'.  ${_report}")
    endif()
