...
if("TRUE" STREQUAL "TRUE")
  set(diff_drive_controller_SOURCE_PREFIX /home/ubuntu/diff/src/diff_drive_controller)
  set(diff_drive_controller_DEVEL_PREFIX /home/ubuntu/diff/devel)
  ...
  set(diff_drive_controller_INSTALL_PREFIX /home/ubuntu/diff/install)
...
if(NOT "/home/ubuntu/diff/devel/include;/home/ubuntu/diff/src/diff_drive_controller/include " STREQUAL " ")
  set(diff_drive_controller_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntu/diff/devel/include;/home/ubuntu/diff/src/diff_drive_controller/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'diff_drive_controller' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/diff/src/diff_drive_controller/${idir}'.  ${_report}")
    endif()
