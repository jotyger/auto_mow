...
if("FALSE" STREQUAL "TRUE")
  set(xacro_SOURCE_PREFIX /home/pi/test/src/xacro)
  set(xacro_DEVEL_PREFIX /home/pi/test/devel_isolated/xacro)
  set(xacro_INSTALL_PREFIX "")
  set(xacro_PREFIX ${xacro_DEVEL_PREFIX})
else()
  set(xacro_SOURCE_PREFIX "")
  set(xacro_DEVEL_PREFIX "")
  set(xacro_INSTALL_PREFIX /home/pi/test/install_isolated)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'xacro' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/test/install_isolated/${idir}'.  ${_report}")
    endif()
