...
if("FALSE" STREQUAL "TRUE")
  set(combined_robot_hw_tests_SOURCE_PREFIX /home/pi/test/src/ros_control/combined_robot_hw_tests)
  set(combined_robot_hw_tests_DEVEL_PREFIX /home/pi/test/devel_isolated/combined_robot_hw_tests)
  ...
  set(combined_robot_hw_tests_INSTALL_PREFIX /home/pi/test/install_isolated)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'combined_robot_hw_tests' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/test/install_isolated/${idir}'.  ${_report}")
    endif()
