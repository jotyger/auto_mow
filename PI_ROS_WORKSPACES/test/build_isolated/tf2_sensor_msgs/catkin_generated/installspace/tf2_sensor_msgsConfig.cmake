...
if("FALSE" STREQUAL "TRUE")
  set(tf2_sensor_msgs_SOURCE_PREFIX /home/pi/test/src/geometry2/tf2_sensor_msgs)
  set(tf2_sensor_msgs_DEVEL_PREFIX /home/pi/test/devel_isolated/tf2_sensor_msgs)
  ...
  set(tf2_sensor_msgs_INSTALL_PREFIX /home/pi/test/install_isolated)
...
if(NOT "include;/usr/include/eigen3 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tf2_sensor_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/test/install_isolated/${idir}'.  ${_report}")
    endif()
