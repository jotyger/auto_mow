...
if("FALSE" STREQUAL "TRUE")
  set(rqt_controller_manager_SOURCE_PREFIX /home/pi/test/src/ros_control/rqt_controller_manager)
  set(rqt_controller_manager_DEVEL_PREFIX /home/pi/test/devel_isolated/rqt_controller_manager)
  ...
  set(rqt_controller_manager_INSTALL_PREFIX /home/pi/test/install_isolated)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rqt_controller_manager' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/test/install_isolated/${idir}'.  ${_report}")
    endif()
