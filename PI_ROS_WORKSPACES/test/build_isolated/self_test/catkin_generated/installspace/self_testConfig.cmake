...
if("FALSE" STREQUAL "TRUE")
  set(self_test_SOURCE_PREFIX /home/pi/test/src/diagnostics/self_test)
  set(self_test_DEVEL_PREFIX /home/pi/test/devel_isolated/self_test)
  ...
  set(self_test_INSTALL_PREFIX /home/pi/test/install_isolated)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'self_test' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/test/install_isolated/${idir}'.  ${_report}")
    endif()
