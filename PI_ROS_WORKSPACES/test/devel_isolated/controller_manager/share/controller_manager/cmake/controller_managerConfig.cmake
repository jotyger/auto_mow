...
if("TRUE" STREQUAL "TRUE")
  set(controller_manager_SOURCE_PREFIX /home/pi/test/src/ros_control/controller_manager)
  set(controller_manager_DEVEL_PREFIX /home/pi/test/devel_isolated/controller_manager)
  ...
  set(controller_manager_INSTALL_PREFIX /home/pi/test/install_isolated)
...
if(NOT "/home/pi/test/src/ros_control/controller_manager/include;/usr/include " STREQUAL " ")
  set(controller_manager_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/test/src/ros_control/controller_manager/include;/usr/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'controller_manager' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/test/src/ros_control/controller_manager/${idir}'.  ${_report}")
    endif()
