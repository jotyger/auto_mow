...
if(NOT "/home/pi/test/src/bond_core/bondcpp/include;/usr/include " STREQUAL " ")
  set(bondcpp_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/test/src/bond_core/bondcpp/include;/usr/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'bondcpp' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/test/src/bond_core/bondcpp/${idir}'.  ${_report}")
    endif()
