...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gazebo_dev' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/test/src/gazebo_ros_pkgs/gazebo_dev/${idir}'.  ${_report}")
    endif()
...
set(pkg_cfg_extras "/home/pi/test/src/gazebo_ros_pkgs/gazebo_dev/cmake/gazebo_dev-extras.cmake")
