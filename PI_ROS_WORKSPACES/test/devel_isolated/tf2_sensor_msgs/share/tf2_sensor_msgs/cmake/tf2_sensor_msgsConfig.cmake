...
if(NOT "/home/pi/test/src/geometry2/tf2_sensor_msgs/include;/usr/include/eigen3 " STREQUAL " ")
  set(tf2_sensor_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/test/src/geometry2/tf2_sensor_msgs/include;/usr/include/eigen3")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tf2_sensor_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/test/src/geometry2/tf2_sensor_msgs/${idir}'.  ${_report}")
    endif()
