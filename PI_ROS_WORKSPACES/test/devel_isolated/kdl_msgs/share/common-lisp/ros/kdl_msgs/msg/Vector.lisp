...
(cl:defmethod cl:initialize-instance :after ((m <Vector>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Vector)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name kdl_msgs-msg:<Vector> is deprecated: use kdl_msgs-msg:Vector instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Vector>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kdl_msgs-msg:x-val is deprecated.  Use kdl_msgs-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Vector>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kdl_msgs-msg:y-val is deprecated.  Use kdl_msgs-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <Vector>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kdl_msgs-msg:z-val is deprecated.  Use kdl_msgs-msg:z instead.")
  (z m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Vector>)))
  ...
  (cl:format cl:nil "# Represents a KDL::Vector instance.~%# This message is compatible to geometry_msgs/Vector3.~%~%float64 x~%float64 y~%float64 z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Vector)))
  "Returns full string definition for message of type 'Vector"
  (cl:format cl:nil "# Represents a KDL::Vector instance.~%# This message is compatible to geometry_msgs/Vector3.~%~%float64 x~%float64 y~%float64 z~%~%~%"))
