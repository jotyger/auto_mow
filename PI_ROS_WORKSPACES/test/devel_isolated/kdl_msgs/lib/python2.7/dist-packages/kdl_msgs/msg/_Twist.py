...
"""autogenerated by genpy from kdl_msgs/Twist.msg. Do not edit."""
import sys
...
class Twist(genpy.Message):
  ...
  _type = "kdl_msgs/Twist"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# Represents a KDL::Twist instance.
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.linear is None:
        self.linear = kdl_msgs.msg.Vector()
      if self.angular is None:
        self.angular = kdl_msgs.msg.Vector()
    else:
      self.linear = kdl_msgs.msg.Vector()
      self.angular = kdl_msgs.msg.Vector()
