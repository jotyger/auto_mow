...
"""autogenerated by genpy from kdl_msgs/WrenchStamped.msg. Do not edit."""
import sys
...
class WrenchStamped(genpy.Message):
  ...
  _type = "kdl_msgs/WrenchStamped"
  _has_header = True #flag to mark the presence of a Header object
  _full_text = """# Represents a stamped KDL::Wrench instance.
...
"""
  ...
  _slot_types = ['std_msgs/Header','kdl_msgs/Wrench']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.wrench is None:
        self.wrench = kdl_msgs.msg.Wrench()
    else:
      self.header = std_msgs.msg.Header()
      self.wrench = kdl_msgs.msg.Wrench()
