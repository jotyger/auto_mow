...
if("TRUE" STREQUAL "TRUE")
  set(roswtf_SOURCE_PREFIX /home/pi/test/src/ros_comm/roswtf)
  set(roswtf_DEVEL_PREFIX /home/pi/test/devel_isolated/roswtf)
  set(roswtf_INSTALL_PREFIX "")
  set(roswtf_PREFIX ${roswtf_DEVEL_PREFIX})
else()
  set(roswtf_SOURCE_PREFIX "")
  set(roswtf_DEVEL_PREFIX "")
  set(roswtf_INSTALL_PREFIX /home/pi/test/install_isolated)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'roswtf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/test/src/ros_comm/roswtf/${idir}'.  ${_report}")
    endif()
