...
if(NOT "/home/pi/test/devel_isolated/controller_manager_msgs/include " STREQUAL " ")
  set(controller_manager_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/test/devel_isolated/controller_manager_msgs/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'controller_manager_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/test/src/ros_control/controller_manager_msgs/${idir}'.  ${_report}")
    endif()
