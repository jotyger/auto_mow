...
if(NOT "/home/pi/test/src/diagnostics/self_test/include " STREQUAL " ")
  set(self_test_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/test/src/diagnostics/self_test/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'self_test' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/test/src/diagnostics/self_test/${idir}'.  ${_report}")
    endif()
