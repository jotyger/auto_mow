...
if(NOT "/home/pi/test/src/geometry2/tf2_ros/include " STREQUAL " ")
  set(tf2_ros_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/test/src/geometry2/tf2_ros/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tf2_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/test/src/geometry2/tf2_ros/${idir}'.  ${_report}")
    endif()
