...
if("TRUE" STREQUAL "TRUE")
  set(nodelet_SOURCE_PREFIX /home/pi/test/src/nodelet_core/nodelet)
  set(nodelet_DEVEL_PREFIX /home/pi/test/devel_isolated/nodelet)
  set(nodelet_INSTALL_PREFIX "")
  set(nodelet_PREFIX ${nodelet_DEVEL_PREFIX})
else()
  set(nodelet_SOURCE_PREFIX "")
  set(nodelet_DEVEL_PREFIX "")
  set(nodelet_INSTALL_PREFIX /home/pi/test/install_isolated)
...
if(NOT "/home/pi/test/devel_isolated/nodelet/include;/home/pi/test/src/nodelet_core/nodelet/include;/usr/include " STREQUAL " ")
  set(nodelet_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/test/devel_isolated/nodelet/include;/home/pi/test/src/nodelet_core/nodelet/include;/usr/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'nodelet' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/test/src/nodelet_core/nodelet/${idir}'.  ${_report}")
    endif()
