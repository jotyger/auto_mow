...
if("TRUE" STREQUAL "TRUE")
  set(rosmake_SOURCE_PREFIX /home/pi/test/src/ros/rosmake)
  set(rosmake_DEVEL_PREFIX /home/pi/test/devel_isolated/rosmake)
  set(rosmake_INSTALL_PREFIX "")
  set(rosmake_PREFIX ${rosmake_DEVEL_PREFIX})
else()
  set(rosmake_SOURCE_PREFIX "")
  set(rosmake_DEVEL_PREFIX "")
  set(rosmake_INSTALL_PREFIX /home/pi/test/install_isolated)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosmake' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/test/src/ros/rosmake/${idir}'.  ${_report}")
    endif()
