...
if("TRUE" STREQUAL "TRUE")
  set(rosbag_SOURCE_PREFIX /home/pi/test/src/ros_comm/rosbag)
  set(rosbag_DEVEL_PREFIX /home/pi/test/devel_isolated/rosbag)
  set(rosbag_INSTALL_PREFIX "")
  set(rosbag_PREFIX ${rosbag_DEVEL_PREFIX})
else()
  set(rosbag_SOURCE_PREFIX "")
  set(rosbag_DEVEL_PREFIX "")
  set(rosbag_INSTALL_PREFIX /home/pi/test/install_isolated)
...
if(NOT "/home/pi/test/src/ros_comm/rosbag/include " STREQUAL " ")
  set(rosbag_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/test/src/ros_comm/rosbag/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosbag' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/test/src/ros_comm/rosbag/${idir}'.  ${_report}")
    endif()
