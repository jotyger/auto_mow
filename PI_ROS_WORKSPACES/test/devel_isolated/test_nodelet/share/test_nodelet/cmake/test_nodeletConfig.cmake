...
if("TRUE" STREQUAL "TRUE")
  set(test_nodelet_SOURCE_PREFIX /home/pi/test/src/nodelet_core/test_nodelet)
  set(test_nodelet_DEVEL_PREFIX /home/pi/test/devel_isolated/test_nodelet)
  ...
  set(test_nodelet_INSTALL_PREFIX /home/pi/test/install_isolated)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'test_nodelet' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/test/src/nodelet_core/test_nodelet/${idir}'.  ${_report}")
    endif()
