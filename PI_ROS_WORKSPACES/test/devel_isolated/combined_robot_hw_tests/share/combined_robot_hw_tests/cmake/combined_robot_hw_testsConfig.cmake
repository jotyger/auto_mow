...
if(NOT "/home/pi/test/src/ros_control/combined_robot_hw_tests/include " STREQUAL " ")
  set(combined_robot_hw_tests_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/test/src/ros_control/combined_robot_hw_tests/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'combined_robot_hw_tests' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/test/src/ros_control/combined_robot_hw_tests/${idir}'.  ${_report}")
    endif()
