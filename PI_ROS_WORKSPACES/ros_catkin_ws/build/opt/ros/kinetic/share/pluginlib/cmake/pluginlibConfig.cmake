...
if("FALSE" STREQUAL "TRUE")
  ...
  set(pluginlib_INSTALL_PREFIX /home/pi/ros_catkin_ws/build/opt/ros/kinetic)
...
if(NOT "include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pluginlib' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/ros_catkin_ws/build/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
