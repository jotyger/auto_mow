...
if("TRUE" STREQUAL "TRUE")
  ...
  set(camera_calibration_parsers_INSTALL_PREFIX /home/pi/ros_catkin_ws/install_isolated)
...
if(NOT "/home/pi/ros_catkin_ws/src/image_common/camera_calibration_parsers/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'camera_calibration_parsers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/ros_catkin_ws/src/image_common/camera_calibration_parsers/${idir}'.  ${_report}")
    endif()
